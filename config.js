module.exports = {
    ...
    maximumLetters: 20, // The maximum amount of letter that can be generated. 20 is the highest.
    useDiscordWebhook: {
        enabled: true, //Send a msg to the webhook channel if there is a name that successfully sniped
